...
Java_com_anonamus_mobileagent_runtime_NativeSpawn_spawn(JNIEnv *env, jobject self, jobjectArray java_argv,
...
Java_com_anonamus_mobileagent_runtime_NativeSpawn_waitFor(JNIEnv *env, jobject self, jint pid, jboolean no_hang) {
    (void)env; (void)self;
    int status = 0;
...
JNIEXPORT jint JNICALL
Java_com_anonamus_mobileagent_runtime_NativeSpawn_kill(JNIEnv *env, jobject self, jint pid, jint signal) {
    (void)env; (void)self;
