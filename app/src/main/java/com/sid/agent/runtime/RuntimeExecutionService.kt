...
import com.sid.agent.MainActivity
import com.sid.agent.R
...
class RuntimeExecutionService : Service() {
    ...
    private fun acquireWakeLock() {
        ...
        wakeLock = getSystemService(PowerManager::class.java)
            .newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.sid.agent:active-coding-task")
    ...
    companion object {
        const val ACTION_START = "com.sid.agent.START_RUNTIME"
        const val ACTION_STOP = "com.sid.agent.STOP_RUNTIME"
        const val ACTION_PROGRESS = "com.sid.agent.PROGRESS_RUNTIME"
        const val ACTION_COMPLETE = "com.sid.agent.COMPLETE_RUNTIME"
        const val ACTION_FAILED = "com.sid.agent.FAIL_RUNTIME"
        const val ACTION_CANCELLED = "com.sid.agent.CANCEL_RUNTIME"
