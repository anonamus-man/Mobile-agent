...
object RuntimeLaunchConfigBuilder {
    fun build(profile: ProviderProfile, authToken: String? = null, localGatewayUrl: String? = null): RuntimeLaunchConfig {
        ...
        when (profile.kind.protocol) {
            com.anonamus.mobileagent.model.ProviderProtocol.CLAUDE_LOGIN -> Unit
            com.anonamus.mobileagent.model.ProviderProtocol.ANTHROPIC -> {
                environment["ANTHROPIC_BASE_URL"] = profile.baseUrl.trimEnd('/')
                environment["ANTHROPIC_MODEL"] = profile.model
            }
            com.anonamus.mobileagent.model.ProviderProtocol.ANTHROPIC_GATEWAY -> {
                environment["ANTHROPIC_BASE_URL"] = profile.baseUrl.trimEnd('/')
                environment["ANTHROPIC_MODEL"] = profile.model
            }
            com.anonamus.mobileagent.model.ProviderProtocol.OPENAI_RESPONSES,
            com.anonamus.mobileagent.model.ProviderProtocol.OPENAI_CHAT,
            -> {
        ...
        if (profile.kind.protocol != com.anonamus.mobileagent.model.ProviderProtocol.CLAUDE_LOGIN) {
