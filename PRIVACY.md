# Mobile Agent Privacy Policy

**Effective date:** August 24, 2026

Mobile Agent is a local-first Android development workspace. This policy explains what information the app handles, where it is stored, and when information leaves the device.

## Information handled by the app

Mobile Agent may handle the following information when you choose to provide it:
...
Mobile Agent does not currently include advertising or analytics SDKs and does not operate a first-party user account system.
...
Mobile Agent does not sell personal information. It does not send projects or conversations to the Mobile Agent developer unless you explicitly share them, submit diagnostics, or use a future opt-in backup or support feature.
...
Local information remains on the device until you delete the relevant project, clear it from the app, or uninstall Mobile Agent. Uninstalling the app removes its private local data according to Android's behavior.
...
Mobile Agent uses app-private Android storage, Android Keystore-backed credential encryption, HTTPS for external services, and checksum verification for supported runtime downloads. No system can guarantee complete security. Code executed inside the local Linux environment should be limited to projects and dependencies you trust.

## Children

Mobile Agent is a developer tool and is not directed to children under 13. The app does not knowingly collect personal information from children.

## Changes to this policy

This policy may be updated as Mobile Agent changes. Material changes will be reflected by updating the effective date and publishing the revised policy at the same public URL.

## Contact

For privacy questions or requests, open an issue at [github.com/anonamus-man/Mobile-agent/issues](https://github.com/anonamus-man/Mobile-agent/issues).
